...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://bgm7a1kkt7.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'Accept', 'Access-Control-Allow-Origin', 'Content-Type', 'Access-Control-Allow-Headers', 'x-amz-meta-customLabels', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketKeyPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Accept', 'Access-Control-Allow-Origin', 'Content-Type', 'Access-Control-Allow-Headers', 'x-amz-meta-customLabels', 'Access-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
